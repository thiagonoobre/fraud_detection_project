...
# Caminho absoluto da raiz do projeto fraud-lakehouse
BASE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../"))

# Agora defina o caminho de output relativo à raiz do projeto
DIR_OUTPUT = os.path.join(BASE_DIR, "data", "raw", "transactions")
...
for day in range(transactions_df.TX_TIME_DAYS.max() + 1):
    ...
    transactions_day.to_pickle(os.path.join(DIR_OUTPUT, filename_output), protocol=4)

output_dir_customer = os.path.join(BASE_DIR, "data", "raw", "customer_profiles")
output_dir_terminal = os.path.join(BASE_DIR, "data", "raw", "terminal_profiles")
os.makedirs(output_dir_customer, exist_ok=True)
os.makedirs(output_dir_terminal, exist_ok=True)

customer_profiles_table.to_csv(os.path.join(output_dir_customer, "customer_profiles_table.csv"), index=False)
terminal_profiles_table.to_csv(os.path.join(output_dir_terminal, "terminal_profiles_table.csv"), index=False)
